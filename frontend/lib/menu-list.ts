      ...
      menus: [
        ...
        // --- TAMBAHAN MENU INVENTORY ---
        {
          ...
          submenus: [
            ...
            {
              href: `${basePath}/inventory/internal-transfer`,
              label: "Internal Transfer",
              tooltip: "Transfer Internal (Simple)",
              icon: ArrowLeftRight,
    ...
    },
    {
      ...
      menus: [
        ...
        },
        {
          ...
          submenus: [
            {
              href: "/super-admin-area/setting/umum",
            ...
            {
              href: "/super-admin-area/setting/notifikasi",
              label: "Notifikasi",
            ...
            {
              href: "/super-admin-area/setting/payroll",
              label: "Parameter Gaji",
              tooltip: "Pengaturan Parameter Gaji & Lembur",
              icon: Banknote,
              active: isActive("/super-admin-area/setting/payroll", pathname),
              requiredPermission: "settings.system",
            },
            {
              href: "/super-admin-area/setting/location",
              label: "Koordinat Absensi",
              tooltip: "Pengaturan Koordinat & Geofencing Absensi",
              icon: Landmark,
