...
export default function UpdatePurchaseOrderPage() {
    ...
    const handleCancel = () => {
        if (purchaseOrder) {
            router.push(`/admin-area/logistic/purchasing/${purchaseOrder.id}`);
        } else {
            router.push("/admin-area/logistic/purchasing");
        }
    };
            ...
            <div className="container mx-auto p-4 md:p-6 space-y-6">
                ...
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbItem>
                            <BreadcrumbLink
                                href={`/admin-area/logistic/purchasing/${purchaseOrder.id}`}
                                className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors"
                            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <Card className="bg-gradient-to-br from-card to-purple-50 dark:to-purple-950/20 border-purple-200 dark:border-purple-800 hover:shadow-lg transition-shadow cursor-pointer group"
                        onClick={() => router.push(`/admin-area/logistic/purchasing/${purchaseOrder.id}`)}>
                        <CardContent className="p-6">
                            <div className="flex items-center gap-4">
