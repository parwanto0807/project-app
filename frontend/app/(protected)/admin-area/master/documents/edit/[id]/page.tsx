...
export default function EditDocumentPageAdmin({ params }: { params: Promise<{ id: string }> }) {
    const { id } = use(params);
    ...
    return (
        <AdminLayout title="Edit Dokumen" role="admin">
            <div className="mb-6">
                <Breadcrumb>
                    <BreadcrumbList>
                        <BreadcrumbItem>
            ...
            <div className="bg-card rounded-lg border shadow-sm p-6">
                <DocumentForm role="admin" initialData={initialData} />
            </div>
        </AdminLayout>
    );
}
