        ...
        <AdminLayout title="Inventory Dashboard" role={user?.role || "guest"}>
            <div className="flex-1 space-y-4 p-4 md:p-6 pt-6">
                    ...
                    <BreadcrumbList>
                        <BreadcrumbItem>
                            <Badge variant="outline">
                                <BreadcrumbLink href="/admin-area">Admin Area</BreadcrumbLink>
                            </Badge>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                ...
                <DashboardClient
                    ...
                    initialTotalValue={res.success && res.data && res.data.summary ? res.data.summary.totalInventoryValue : 0}
