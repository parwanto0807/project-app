...
export default async function CreateGoodsReceiptPage({ searchParams }: PageProps) {
    ...
    return (
        <AdminLayout title="Create Goods Receipt" role="admin">
            {/* Breadcrumb */}
            <Breadcrumb>
                <BreadcrumbList>
                    <BreadcrumbItem>
                        <BreadcrumbLink href="/admin-area/dashboard">Dashboard</BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbLink href="/admin-area/inventory/goods-receipt">
                            Goods Receipts
                        </BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
            ...
            <div className="flex-1 min-h-0 overflow-auto">
                <div className="space-y-4 p-2 pt-1 md:p-4">
                    ...
                    <HeaderCard
                        ...
                        showActionArea={true}
                        actionArea={
                            <Link href="/admin-area/inventory/goods-receipt">
