...
import { ManualCreateQuotationForm } from "@/components/sales/quotation/createFormDataManual";
import { Customer, Product, CreateQuotationRequest, Tax, PaymentTerm } from "@/types/quotation";
import { useSession } from "@/components/clientSessionProvider";

export default function CreateManualQuotationPageAdmin() {
    ...
    // Hook fetching data (tidak perlu salesOrders untuk form manual)
    ...
    // Loading gabungan: user + semua data dependencies (tanpa salesOrders)
    ...
    // Filter data yang sudah tersedia (tanpa salesOrders)
    ...
    if (isDataLoading) {
        return <AdminLoading message="Preparing Manual Quotation creation form..." />;
    }

    return (
        <AdminLayout title="Create Manual Quotation" role="admin">
            <Breadcrumb>
                <BreadcrumbList>
                    <BreadcrumbItem>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbPage>Create Manual</BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
