...
export default function DocumentsPageSuper() {
    ...
    return (
        <AdminLayout title="JobDesk & SOP" role="super">
            <div className="mb-6">
                <Breadcrumb>
                    <BreadcrumbList>
                        <BreadcrumbItem>
            ...
            <div className="mb-6">
                <h2 className="text-2xl font-bold tracking-tight">Daftar JobDesk & SOP (Super Admin)</h2>
                <p className="text-muted-foreground mt-1">
                    Kelola dokumen deskripsi pekerjaan dan standar operasional prosedur perusahaan
                </p>
            </div>

            <DocumentList role="super" />
        </AdminLayout>
    );
}
