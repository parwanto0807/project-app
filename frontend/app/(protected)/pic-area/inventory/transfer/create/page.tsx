...
export default function CreateTransferPage() {
    ...
    const handleSuccess = () => {
        router.push('/pic-area/inventory/transfer');
    };
    ...
    return (
        <PicLayout title="Create Transfer" role="pic">
            <Breadcrumb>
                <BreadcrumbList>
                    <BreadcrumbItem>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbLink href="/pic-area/inventory/transfer">Transfer</BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
