...
export default function MFAInputPage() {
  ...
  useEffect(() => {
    ...
    ;((...args: any[]) => {})("🔐 [OTP PAGE] Session check:", {
  ...
  const onSubmit = async (data: { otp: string }) => {
    ...
    try {
      ;((...args: any[]) => {})("🔐 [OTP VERIFY] Starting verification...", {
        hasTempToken: !!tempToken,
        hasDeviceId: !!deviceId,
      ...
      ;((...args: any[]) => {})("✅ [OTP VERIFY] Success! Finalizing login...");
      ...
      //   ;((...args: any[]) => {})("🔐 [OTP] Tokens initialized via initializeTokensOnLogin");
      // } else {
      ...
      if (json.deviceToken) {
        ...
        ;((...args: any[]) => {})("🔐 [OTP] Trusted device token saved");
      }
      ...
      ;((...args: any[]) => {})("✅ [OTP] Cleanup completed, redirecting...");
