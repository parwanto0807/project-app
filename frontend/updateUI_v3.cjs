...
const parseCurrency = (val: string) => {
  ...
  if (!code.includes('name="payrollConfigId"')) {
    const searchString = `                                                <SelectItem value="HARIAN_BULANAN">2. Harian di Bayar Bulanan</SelectItem>\n                                            </SelectContent>\n                                        </Select>\n                                        <FormMessage /></FormItem>\n                                )} />`;
    const replaceString = `                                                <SelectItem value="HARIAN_BULANAN">2. Harian di Bayar Bulanan</SelectItem>
                                            </SelectContent>
                                        </Select>
                                        <FormMessage /></FormItem>
                                )} />
  ...
  // 6. Fix res.success logic if it was already injected incorrectly in updateFormData (which didn't get reverted)
