...
import { createInvoice } from "@/lib/action/invoice/invoice";
...
import { CreateInvoiceRequest } from "@/schemas/invoice";
...
export function CreateInvoiceForm({ currentUser, salesOrders, users, banks }: CreateInvoiceFormProps) {
    ...
    const form = useForm({
        ...
        defaultValues: {
            invoiceNumber: "GENERATE BY SYSTEM",
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input placeholder="00001/INV-RYLIF/IX/2025" {...field} disabled />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
