                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        {({ loading }) => (
                            ...
                            >
                                <Download size={16} /> {loading ? "Preparing..." : "Export PDF"}
                            </Button>
                        )}
                    </PDFDownloadLink>
                </div>
                    ...
                    <div className="flex justify-between items-start mb-6">
                        <div className="space-y-1">
                            <Badge variant="outline" className="mb-2 bg-primary/10 text-primary border-primary/20">
                                {docData.type === "JOB_DESCRIPTION" ? "JOB DESCRIPTION" : "STANDARD OPERATING PROCEDURE"}
                            </Badge>
                            <h1 className="text-3xl font-bold tracking-tight text-gray-900">{docData.title}</h1>
                        </div>
                        <div className="text-right space-y-1">
                            <div className="text-sm font-semibold text-gray-500">VERSION</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 text-sm">
                        ...
                        <div className="flex items-center gap-2 text-gray-600">
                            ...
                            <div>
                                ...
                                {format(new Date(docData.createdAt), "dd MMMM yyyy")}
                            </div>
                        </div>
                        <div className="flex items-center gap-2 text-gray-600">
