...
export const CreateQuotationForm: React.FC<CreateQuotationFormProps> = ({
    ...
    const [quotationSource, setQuotationSource] = useState<'manual' | 'sales-order'>('manual');
    const [selectedSalesOrderId, setSelectedSalesOrderId] = useState<string>('');

    // Perbaiki fungsi handleSalesOrderChange:
    ...
    const handleLineChange = (index: number, field: keyof CreateQuotationLineRequest, value: string | number | LineType | DiscountType | null) => {
        const updatedLines = lines.map((line, i) => {
            if (i === index) {
                return {
                    ...line,
                    [field]: value === undefined ? '' : value // Handle undefined values
                };
            }
            return line;
        });
    ...
    const handleProductChange = (index: number, productId: string) => {
        // Pastikan productId selalu string, bahkan untuk empty value
        ...
        if (safeProductId === '') {
            setLines(prev => prev.map((line, i) =>
                i === index ? {
                    ...line,
                    productId: '', // konsisten string kosong
                    description: '', // konsisten string kosong
                    unitPrice: 0,
                    uom: '' // konsisten string kosong
                } : line
            ));
            return;
        }
        ...
        if (product) {
            setLines(prev => prev.map((line, i) =>
                i === index ? {
                    ...
                    description: product.name || '', // pastikan tidak undefined
                    unitPrice: product.price || 0, // pastikan tidak undefined
                    uom: product.uom || '' // pastikan tidak undefined
                } : line
            ));
        }
    };
    ...
    const getLineTypeIcon = (lineType: LineType) => {
        switch (lineType) {
            ...
            case LineType.FREIGHT: return <Truck className="w-4 h-4 text-orange-600" />;
    ...
    const getLineTypeBadge = (lineType: LineType) => {
        switch (lineType) {
            ...
            case LineType.FREIGHT: return <Badge variant="secondary" className="bg-orange-100 text-orange-800 border-orange-200">Freight</Badge>;
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 bg-white dark:bg-slate-900 dark:text-white rounded-lg shadow-sm">
            ...
            <div className="border-b border-gray-200 pb-4 mb-6">
                ...
                <p className="text-gray-600">Fill in the details below to create a new quotation</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Card className="bg-gradient-to-r from-primary/5 to-cyan-100 dark:from-slate-800 dark:to-blue-950 border-0">
                    ...
                    <CardContent className="px-6">
                        {/* Source Type */}
                        <Label className="text-sm font-medium text-foreground/80">Quotation Source</Label>
                        <div className="grid grid-cols-1 md:grid-cols-8 space-y-4">
                            <div className="md:col-span-3 md:col-start-1 pt-4">
                                <RadioGroup
                                    value={quotationSource}
                                    onValueChange={(value: 'manual' | 'sales-order') => {
                                        setQuotationSource(value);
                                        if (value === 'manual') {
                                            setLines([{
                                                lineType: LineType.PRODUCT,
                                                productId: '',
                                ...
                                >
                                    <div className="flex items-center space-x-2 p-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                        ...
                                        />
                                        <Label htmlFor="source-manual" className="flex items-center cursor-pointer font-medium">
                                            <PenLineIcon className="w-4 h-4 mr-2 text-orange-600" />
                                            Manual Input
                                        </Label>
                                    </div>
                                    <div className="flex items-center space-x-2 p-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                        <RadioGroupItem
                                            value="sales-order"
                                            id="source-sales-order"
                                            className="text-primary border-gray-300"
                                        />
                                        <Label htmlFor="source-sales-order" className="flex items-center cursor-pointer font-medium">
                                            <DockIcon className="w-4 h-4 mr-2 text-orange-600" />
                                            From Sales Order
                                        </Label>
                                    </div>
                                </RadioGroup>
                            ...
                            {/* Sales Order Selection - Enhanced styling */}
                            <div className='md:col-span-3 md:col-start-4 mt-4'>
                                {quotationSource === 'sales-order' && (
                                    <Select
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
                            ...
                            <div className="md:col-span-3 space-y-2">
                                ...
                                <Select
                                    ...
                                    disabled={quotationSource === 'sales-order'} // Optional: disable ketika dari sales order
                                >
                                    <SelectTrigger className="bg-white dark:bg-gray-800 dark:text-white">
                                        <SelectValue placeholder="Select Customer" />
                                        {quotationSource === 'sales-order' && formData.customerId && (
                ...
                <Card className="bg-gradient-to-r from-primary/5 to-blue-100 dark:from-slate-800 dark:to-slate-900 border-0">
                            ...
                            <Card key={index} className="border-2">
                                <CardHeader className="pb-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        {/* Tombol hapus hanya aktif untuk manual input */}
                                        {quotationSource === 'manual' && lines.length > 1 && (
                                            <Button
                                                type="button"
                                                variant="ghost"
                                                size="icon"
                                ...
                                <CardContent className="space-y-4">
                                    <div className="grid grid-cols-1 lg:grid-cols-8 gap-4">
                                        {/* Line Type - disabled ketika menggunakan sales order */}
                                        <div className="lg:col-span-1 lg:col-start-1 space-y-2">
                                            ...
                                            <Select
                                                ...
                                                disabled={quotationSource === 'sales-order'}
                                            >
                                                <SelectTrigger>
                                                    <SelectValue />
                                                </SelectTrigger>
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value={LineType.FREIGHT}>Freight</SelectItem>
                                                    <SelectItem value={LineType.OTHER}>Other</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>

                                        {/* Product Selection - disabled ketika menggunakan sales order */}
                                        ...
                                        {/* Description - disabled ketika menggunakan sales order */}
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-8 lg:grid-cols-8 gap-2">
                                        {/* Quantity - disabled ketika menggunakan sales order */}
                                        <div className="space-y-2">
                                        ...
                                        {/* UOM - disabled ketika menggunakan sales order */}
                                        <div className="space-y-2">
                                            <Label>Unit</Label>
                                            <Input
                                                type="text"
                                        ...
                                        {/* Unit Price - disabled ketika menggunakan sales order */}
                                        ...
                                        {/* Tax - bisa diubah bahkan ketika menggunakan sales order */}
                                        <div className="space-y-2">
                                            <Label>Tax</Label>
                                            <Select
                                                value={line.taxId || ""}
                                        ...
                                        <div className='md:col-span-3 lg:col-span-3 space-y-2'>
                                            {/* Line Discount - bisa diubah bahkan ketika menggunakan sales order */}
                    ...
                    {/* Tombol Add Item hanya aktif untuk manual input */}
