...
interface CreateSalesOrderButtonProps {
  role: string;
...
const CreateSalesOrderButton = ({
  ...
  const getBasePath = (userRole: string) => {
    ...
    return paths[userRole] || "/admin-area/sales/salesOrder";
  };
  ...
  const handleClick = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      console.error("Error navigating to Sales Order create page:", error);
      setIsLoading(false);
      setIsNavigating(false);
    }
  };
