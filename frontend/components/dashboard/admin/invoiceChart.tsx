                ...
                {displayedData.map((item, index) => {
                    ...
                    return (
                        <div
                            ...
                            style={{ width: `${100 / displayedData.length}%` }}
                        >
                            <div className={`text-[10px] sm:text-xs font-semibold ${themeColors[theme].total.text}`}>
                                {formatIDR(totalValue)}
                            </div>
                            <div className={`text-[10px] sm:text-xs font-semibold ${themeColors[theme].paid_total.text}`}>
                                {formatIDR(paidValue)}
                            </div>
                        </div>
                    );
