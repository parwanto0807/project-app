        ...
        <Tabs defaultValue="list" value={activeTab} onValueChange={(v) => setActiveTab(v as TabType)} className="w-full">
          ...
          <TabsContent value="history" className="animate-fade-in">
            ...
            <Card className="border-border/40 bg-card/90 backdrop-blur-sm shadow-md rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg max-h-[50vh]">
              <CardHeader className="pb-3 bg-gradient-to-r from-purple-50 to-white dark:from-purple-900/30 dark:to-gray-800 sticky top-0 z-10">
                <CardTitle className="text-base font-semibold flex items-center gap-2">
              ...
              <CardContent className="pt-4 overflow-y-auto" style={{ maxHeight: 'calc(50vh - 80px)' }}>
                {loadingReports ? (
                  ...
                  <div className="text-center py-8 text-muted-foreground">
                    <Archive className="mx-auto h-12 w-12 opacity-30" />
                          ...
                          >
                            ...
                            <TableCell>
                              <div className="space-y-0.5">
                                <div className="font-medium text-foreground text-sm">{report.spkNumber}</div>
                                <div className="text-xs text-muted-foreground">{report.itemName}</div>
                              </div>
                            </TableCell>
                            ...
                            <TableCell>
                              <div className="space-y-0.5">
                                <div className="text-sm font-medium text-foreground">{report.clientName}</div>
                            ...
                            <TableCell>
                              {report.photos.length > 0 ? (
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <span className="text-xs text-muted-foreground">{report.photos.length} foto</span>
                                </div>
                              ) : (
                                <span className="text-xs text-muted-foreground/70">-</span>
                              )}
                              ...
                              <TableCell>
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <Button
                                    variant="outline"
                                    size="lg"
                                    className="h-8 w-8 p-0 text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300"
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      setSelectedReport(report);
                ...
                {/* Action Bar */}
                {reports.length > 0 && (
                  <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-end sticky bottom-0 bg-card py-3 px-4 rounded-b-lg border-t border-border/40">
