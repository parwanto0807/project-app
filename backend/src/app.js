...
import operationalExpenseRoutes from './routes/finance/operationalExpenseRoutes.js';
...
import kegiatanRoutes from './routes/kegiatan/kegiatanRoutes.js';
import payrollRoutes from './routes/payroll/payrollRoutes.js';
import mealAllowanceRoutes from './routes/payroll/mealAllowanceRoutes.js';
...
app.use("/api/team", karyawanRoutes); // Team endpoints ada di karyawanRoutes
...
app.use('/api/finance/operational-expenses', operationalExpenseRoutes);
...
app.use('/api/kegiatan-absensi', kegiatanRoutes);
app.use('/api/payroll', payrollRoutes);
app.use('/api/payroll/meal-allowance', mealAllowanceRoutes);
